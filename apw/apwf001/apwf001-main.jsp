...
<div class="col-xs-12 nopadding">
	...
	<acf:Region id="reg_div_list" type="list" title="ITEM LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="apwf001-search.ajax" readonly="true" autoLoad="false">
				...
				<acf:Column name="location_code" caption="Location Code" hidden="true" width="100"></acf:Column>
	...
	<acf:Region id="reg_mod_main" title="ITEM MAINTENANCE" type="form">
    	...
    	<div class="col-xs-12 form-padding oneline">
     		<label class="control-label col-md-2" for="item_description_2">Item Desc. (2):</label>
      		<div class="col-md-4">    
      			<acf:TextBox id="item_description_2" name="item_description_2" maxlength="30" checkMandatory="true"/>
    	...
    	<div class="col-xs-12 form-padding oneline">
     		<label class="control-label col-md-2" for="location_code">Location Code.:</label>
      		...
      		<div class="col-md-3">    
      			<acf:TextBox id="location_description" name="location_description" checkMandatory="true"/>
    	...
    	<div class="col-xs-12 form-padding oneline">
     		<label class="control-label col-md-2" for="safety_quantity">Safe Qty:</label>
      		<div class="col-md-2">    
      			<acf:TextBox id="safety_quantity" name="safety_quantity" maxlength="8" format="^(([0-9]){0,5}[.]([0-9]){0,2})$"/>
      			     
      		</div>
    	</div> 

    <acf:Region id="remaining_inventory" type="form" title="REMAINING LIST">
   		
		<div class="col-xs-12">
			<acf:Grid id="remaining_browse" url="apwf001-get-remaining-inventory.ajax" readonly="true" autoLoad="true">
	...
	<acf:Region id="inventory" type="form" title="INVENTORY LIST">
   		
		<div class="col-xs-12">
			<acf:Grid id="inventory_browse" url="apwf001-get-inventory.ajax" readonly="true" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
				<acf:Column name="purchase_order_no" caption="Purchase Order No" width="100"></acf:Column>
				<acf:Column name="purchase_order_date" caption="Purchase Order Date" type="date" width="100"></acf:Column>
				...
				<acf:Column name="out_standing_quantity" caption="Outstanding Quantity" width="100"></acf:Column>
