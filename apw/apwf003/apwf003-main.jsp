	    	...
	    	<div class="form-group">
	        	...
	        	<div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
	      		...
	      		<div class="col-lg-5 col-md-6 col-sm-8 col-xs-10">
	      			...
	      			<acf:TextBox id="s_supplier_desc" name="supplier_name" editable="true" multiple="false"/>
	      			<!--<acf:Bind on="initData"><script>
	 					$(this).acfComboBox("init", ${modules} );
	 				</script></acf:Bind>-->
	...
	<acf:Region id="mod_main" title="MODULE MAINTENANCE" type="form">
    	<div class="col-xs-12 form-padding oneline">
     		<label class="control-label col-md-2" for="purchase_order_no">P.O. No.:</label>
      		<div class="col-md-4">    
      			<acf:TextBox id="purchase_order_no" name="purchase_order_no" readonly="false" disabled="true" checkMandatory="true"/>
    	...
    	<div class="col-xs-12 form-padding oneline">
     		<label class="control-label col-md-2" for="purchase_order_date">P.O. Date:</label>
      		<div class="col-md-4">    
      			...
      			<acf:DateTimePicker id="purchase_order_date" name="purchase_order_date" pickDate="true" pickTime="true" displayformat="YYYY/MM/DD" checkMandatory="true">
	...
	<acf:Region id="item_details" title="ITEM DETAILS" type="form">			
		<div class="col-md-12">
			<acf:Grid id="grid_item" url="apwf003-get-item-table.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
				<acf:Column name="item_no" caption="Item No." width="50" editable="true" readonlyIfOld="true" checkMandatory="true" columnKey="true" type="select" initData="${moduleselect}">
				...
				<acf:Column name="purchase_order_no" caption="P.O. NO." width="50" editable="false"></acf:Column>
				<acf:Column name="item_description_1" caption="Item Description" width="150" editable="false" readonly="true"></acf:Column>
				...
				<acf:Column name="tl_cost" caption="Amount($)" width="170" type="number" readonly="true" align="right" editable="true" checkMandatory="true"></acf:Column>
	    ...
	    <div class="col-md-11">
     		...
     		<acf:Button id="Generate_Report" title="Generate Report">
			<acf:Bind on="click">
	    			<script>
...
$(document).on('new', function() {
	...
	$("#frm_main #latest_receive_date").setValue(2017-02-20);
	$("#frm_main #no_of_times_printed").disable();
	$("#frm_main #cancel_date").setValue("2017-02-20");
	$("#frm_main #Other").enable();
	$("#frm_main #TKO").enable();
