	...
	<form id="frm_main" class="form-horizontal" data-role="form" >
    	...
    	<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="consumption_form_no">Consumption Form No.:</label>
      		<div class="col-md-1">
      			<acf:TextBox id="consumption_form_no" name="consumption_form_no" maxlength="8" checkMandatory="true"/>
    	...
    	<div class="col-xs-12 form-padding">
 		...
 		<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="location_code">Location Code:</label>
      		<div class="col-md-1">
      			<acf:TextBox id="location_code" name="location_code" maxlength="3" checkMandatory="true">
    	...
    	<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="programme_no">Programme Number.:</label>
      		<div class="col-md-1">
      			<acf:TextBox id="programme_no" name="programme_no" maxlength="9" checkMandatory="true">
      			<acf:Bind on="change"><script>
 		...
 		<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="business_platform">Business Platform:</label>
      		<div class="col-md-4">
      			<acf:TextBox id="business_platform" name="business_platform" readonly="true" maxlength="30"/> 
      		</div>
     		<label class="control-label col-md-2" for="department">Programme Nat./Dept:</label>
      		<div class="col-md-4">
      			<acf:TextBox id="department" name="department" readonly="true" maxlength="30"/> 
      		</div>
    	</div>
    	...
    	<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="group_no">Group No.:</label>
      		<div class="col-md-1">
      			<acf:TextBox id="group_no" name="group_no" maxlength="2">
      			<acf:Bind on="change"><script>
	...
	<acf:Region id="Item_consumption" type="form" title="ITEM LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="item_browse" url="apwf005-get-consumption-item.ajax" editable="true" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
				<acf:Column name="item_no" caption="ITEM No." width="100" editable="true" readonlyIfOld="true" type="select" checkMandatory="true" columnKey="true" maxlength="7" initData="${itemnoselect}" >
				<acf:Bind on="change"><script>
				...
				<acf:Column name="item_description_1" caption="ITEM DESC." width="100" readonly="true" maxlength="30"></acf:Column>
