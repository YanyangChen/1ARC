...
<div class="col-xs-12 nopadding">
	...
	<form id="frm_main" class="form-horizontal" data-role="form" >
    	...
    	<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="in_stock_location_code">In-stock Loc. Code:</label>
      		<div class="col-md-2">
      			<acf:TextBox id="in_stock_location_code" name="in_stock_location_code" maxlength="60" checkMandatory="true">
      			<acf:Bind on="change"><script>
   						location_code = $(this).getValue(); //this bloack is the same as onLoadSucess except $this value
	   						...
	   						$.ajax({
								...
								success: function(data) {
									...
									console.log(data.location_name);
										$("#frm_main #in_stock_location_name").setValue(data.location_name);
									}
									else {
										//$("#frm_main #supplier_desc").setValue("");
									}
     		...
     		<label class="control-label col-md-2" for="in_stock_location_name">In-stock Loc. Name:</label>
      		<div class="col-md-4">
      			<acf:TextBox id="in_stock_location_name" name="in_stock_location_name" readonly="true" maxlength="60"/> 
      		</div>
	...
	<acf:Region id="receipt_list" type="list" title="SECTION LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="receipt_browse" url="apwf004-get-inventory-table.ajax" editable="true" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
			<acf:Column name="item_no" caption="Item No." width="50" readonly="true"></acf:Column>
			...
			<acf:Column name="received_quantity" caption="Total received quantity" width="100"></acf:Column>
			...
			<acf:Column name="back_order_quantity" caption="TTL Back Order Qty" width="100"></acf:Column>
			<acf:Column name="out_standing_quantity" caption="O/S Qty" width="50"></acf:Column>
			<acf:Column name="un_it" caption="UNIT" width="50"></acf:Column>
			<acf:Column name="unit_cost" caption="Unit Cost" width="50"></acf:Column>
			<acf:Column name="amount" caption="Amount" width="50"></acf:Column>
