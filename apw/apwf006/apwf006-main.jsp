		...
		<form id="frm_search" class="form-horizontal" data-role="search" >
	    	<div class="form-group">
	      		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3">
	      			...
	      			<acf:TextBox id="s_item_no" name="item_no" maxlength="7"/>  
	      		</div>
	...
	<form id="frm_main" class="form-horizontal" data-role="form" >
    	...
    	<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="item_no" >Item No.:</label>
      		<div class="col-md-2">
      			<acf:TextBox id="item_no" name="item_no" checkMandatory="true">
 		...
 		<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="adjustment_date">Adjust Date:</label>
      		<div class="col-md-2">
      			<acf:DateTimePicker id="adjustment_date" name="adjustment_date" maxlength="60" pickTime="false"/> 
      		</div>
    	...
    	<div class="col-xs-12 form-padding">
     		<label class="control-label col-md-2" for="location_code">Location Code:</label>
      		<div class="col-md-1">
      			<acf:TextBox id="location_code" name="location_code" editable="false" maxlength="60" readonly="true" checkMandatory="true">
      			<acf:Bind on="change"><script>
