...
public class APWc004 extends ACFaAppController {
  ...
  //  Search search = new Search();
    ...
    private class Search extends ACFgSearch {
        public Search() {
            super();
            setModel(ARCmPOHeader.class); //define a Search which accept 4 filters from client
    ...
    public ACFgResponseParameters getInventoryTable(@RequestBody ACFgRequestParameters param) throws Exception {                                
      ...
      //  select.setCustomSQL("");
        ...
        select.setCustomSQL("select * from(select I.*, IM.un_it, IM.item_description_1, PD.unit_cost, 0 as trigcrq, 0 as trigcbo, I.received_quantity as pre_received_qty, I.back_order_quantity as pre_back_order_qty, "
